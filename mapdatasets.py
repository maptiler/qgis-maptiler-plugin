...
LOCAL_JP_DATASET = {
    'JP MIERUNE Streets': {
        'raster': r'https://api.maptiler.com/maps/jp-mierune-streets/256/tiles.json?key=',
        'vector': r'https://api.maptiler.com/maps/jp-mierune-streets/style.json?key='
    },
    'JP MIERUNE Dark': {
        'raster': r'https://api.maptiler.com/maps/jp-mierune-dark/256/tiles.json?key=',
        'vector': r'https://api.maptiler.com/maps/jp-mierune-dark/style.json?key='
    },
    'JP MIERUNE Gray': {
        'raster': r'https://api.maptiler.com/maps/jp-mierune-gray/256/tiles.json?key=',
...
LOCAL_NL_DATASET = {
    'NL Cartiqo Dark': {
        'raster': r'https://api.maptiler.com/maps/nl-cartiqo-dark/256/tiles.json?key=',
        'vector': r'https://api.maptiler.com/maps/nl-cartiqo-dark/style.json?key='
    },
    'NL Cartiqo Light': {
        'raster': r'https://api.maptiler.com/maps/nl-cartiqo-light/256/tiles.json?key=',
        'vector': r'https://api.maptiler.com/maps/nl-cartiqo-light/style.json?key='
    },
    'NL Cartiqo Topo': {
        'raster': r'https://api.maptiler.com/maps/nl-cartiqo-topo/256/tiles.json?key=',
