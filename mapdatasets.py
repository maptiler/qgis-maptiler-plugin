STANDARD_DATASET = {
    'Basic': {
        'raster': r'https://api.maptiler.com/maps/basic/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/basic/style.json',
        'customize_url': r'https://maptiler.link/qgisbasic'
    },
    'Bright': {
        'raster': r'https://api.maptiler.com/maps/bright/256/tiles.json',
    ...
    'Outdoor': {
        ...
        'vector': r'https://api.maptiler.com/maps/outdoor/style.json',
        'customize_url': r'https://maptiler.link/qgisoutdoor'
    },
    'Pastel': {
        'raster': r'https://api.maptiler.com/maps/pastel/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/pastel/style.json',
        'customize_url': r'https://maptiler.link/qgispastel'
    },
    'Positron': {
        'raster': r'https://api.maptiler.com/maps/positron/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/positron/style.json',
        'customize_url': r'https://maptiler.link/qgispositron'
    },
    'Satellite': {
        'raster': r'https://api.maptiler.com/tiles/satellite-v2/tiles.json'
    },
    'Satellite Hybrid': {
        'raster': r'https://api.maptiler.com/maps/hybrid/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/hybrid/style.json',
        'customize_url': r'https://maptiler.link/qgishybrid'
    },
    'Streets': {
        'raster': r'https://api.maptiler.com/maps/streets/256/tiles.json',
    ...
    'Toner': {
        ...
        'vector': r'https://api.maptiler.com/maps/toner/style.json',
        'customize_url': r'https://maptiler.link/qgistoner'
    },
    'Topo': {
        'raster': r'https://api.maptiler.com/maps/topo/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/topo/style.json',
    ...
    'Voyager': {
        'raster': r'https://api.maptiler.com/maps/voyager/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/voyager/style.json',
        'customize_url': r'https://maptiler.link/qgisvoyager'
    },
    'Winter': {
        'raster': r'https://api.maptiler.com/maps/winter/256/tiles.json',
        'vector': r'https://api.maptiler.com/maps/winter/style.json',
        'customize_url': r'https://maptiler.link/qgiswinter'
    }
}
